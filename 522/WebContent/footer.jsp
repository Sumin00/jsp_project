...
<footer style="background-color: #000000;">
	...
	<div class="row">
			<div class="bottom_menu">
				...
				<p><a href="#" data-toggle="modal" data-target="#modal1">개인정보처리방침</a></p>
				<p><a href="#" data-toggle="modal" data-target="#modal2">멤버스 이용약관</a></p>
			  ...
			  <div class="modal-dialog" role="document">
			    <div class="modal-content" style="width: 530px;">
			      <div class="modal-header">
			        ...
			        <h5 class="modal-title" id="exampleModalLabel"><br>개인정보처리방침</h5>
			  ...
			  <div class="modal-dialog" role="document" style="width:530px;">
			    <div class="modal-content">
			      <div class="modal-header">
			        ...
			        <h5 class="modal-title" id="exampleModalLabel"><br>멤버스 이용약관</h5>
			      </div>
			      <div class="modal-body">
			      	<textarea style="resize: none; width: 500px; height: 200px" readonly>
제 1장 총칙
